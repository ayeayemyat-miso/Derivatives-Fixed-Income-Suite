...
with st.expander("📊 Trading Strategies & Real-World Application", expanded=False):
    ...
    **📈 Historical Example (2008-2012):**
    - Fed cut rates from 5% to 0%
    - IO strips crashed (lost 60-80% value)
    - PO strips soared (refinancing boom)
    - Hedge funds that bought PO made billions
